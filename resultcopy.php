...
<body>
  ...
  ?>
	                <form id="test" action="resultcopy3.php" method="post">
										...
										<center>
									  <ul  id="progressbar"><b>
    <li class="active" id="active1">Self Efficacy</li>
    <li id="active2">Learning Management</li>
    <li id="active3">Resource Management</li>
		<li id="active4">Interaction Management</li>
		<li id="active5">Motivational Management</li>
  </ul></center></b>
...
<br>
		<input type="button" name="previous" class="previous action-button" value="Previous" style='font-family: Bebas Neue, Arial;font-size:20px;color:white;background-color:red;border-radius: 10px; width:10%; border:1px solid white; align: center; padding:5px;' />
		<input type="button" name="next" class="next action-button" value="Next"  style='font-family: Bebas Neue, Arial; float: right; font-size:20px;color:white;background-color:#27AE60;border-radius: 10px;border:1px solid white; align: center; width:10%; padding:5px;' />
</fieldset>
  <fieldset  id="field_3">
    <table>
